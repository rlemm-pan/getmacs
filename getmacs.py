...
def printheader():
  print >>alldatafile,'Device'+'\t'.expandtabs(12)+'\t'+'Mac-Address'+'\t'.expandtabs(10)+'Interface'+'\t'.expandtabs(10)+'\t'+'IP-Address'+'\t'.expandtabs(6)+'\t'+'L3-Interface'+'\t'.expandtabs(4)+'\t'+'L3-Gateway-Address'+'\t'.expandtabs(4)+'\t'+'Vlan-ID'+'\t'.expandtabs(6)+'\t'+'Vlan-Name'+'\t'.expandtabs(6)+'\t'+'Notes'
  print 'Device'+'\t'.expandtabs(12)+'\t'+'Mac-Address'+'\t'.expandtabs(10)+'Interface'+'\t'.expandtabs(10)+'\t'+'IP-Address'+'\t'.expandtabs(6)+'\t'+'L3-Interface'+'\t'.expandtabs(4)+'\t'+'L3-Gateway-Address'+'\t'.expandtabs(4)+'\t'+'Vlan-ID'+'\t'.expandtabs(6)+'\t'+'Vlan-Name'+'\t'.expandtabs(6)+'\t'+'Notes'
